...
extc int     cdecl _Stringtotext(char *data,int ndata,char *text,int ntext);
...
extc ulong   cdecl _Disasm(uchar *src,ulong srcsize,ulong srcip,uchar *srcdec,
...
extc t_memory* cdecl _Findmemory(ulong addr);
...
extc ulong   cdecl _Readmemory(void *buf,ulong addr,ulong size,int mode);
extc ulong   cdecl _Writememory(void *buf,ulong addr,ulong size,int mode);
...
extc t_module* cdecl _Findmodule(ulong addr);
extc t_fixup* cdecl _Findfixup(t_module *pmod,ulong addr);
extc uchar*  cdecl _Finddecode(ulong addr,ulong *psize);
extc ulong   cdecl _Findfileoffset(t_module *pmod,ulong addr);
extc int     cdecl _Decoderange(ulong addr,ulong size,char *s);
extc int     cdecl _Analysecode(t_module *pm);
...
extc t_status cdecl _Getstatus(void);
...
extc int     cdecl _Plugingetvalue(int type);
